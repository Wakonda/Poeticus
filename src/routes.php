...
// Register routes.
/*$app->get('/', 'Poeticus\Controller\IndexController::indexAction')
    ->bind('index');
	
$app->get('/byauthors', '\Poeticus\Controller\IndexController::byAuthorsAction')
    ->bind('byauthors');

$app->get('/admin2', '\Poeticus\Controller\AdminController::indexAction')
    ->bind('index_admin');*/
